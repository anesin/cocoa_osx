...
class Document: NSDocument {
    ...
    @IBAction func removeEmployees(sender: NSButton) {
        ...
        let informativeText = NSLocalizedString("REMOVE_INFORMATIVE", comment: "The remove alert's informativeText")
    ...
    override func dataOfType(typeName: String) throws -> NSData {
        ...
        let topLevelDictionary: [String: AnyObject] = ["employees": employees, "printInfo": printInfo]
        return NSKeyedArchiver.archivedDataWithRootObject(topLevelDictionary)
//        return NSKeyedArchiver.archivedDataWithRootObject(employees)
    ...
    override func readFromData(data: NSData, ofType typeName: String) throws {
        ...
        if let topLevelDictionary = NSKeyedUnarchiver.unarchiveObjectWithData(data) as? [String : AnyObject] {
            if let employees = topLevelDictionary["employees"] as? [Employee] {
                self.employees = employees
            }
            if let printInfo = topLevelDictionary["printInfo"] as? NSPrintInfo {
    ...
    override func printOperationWithSettings(printSettings: [String : AnyObject]) throws -> NSPrintOperation {
        let employeesPrintingView = EmployeePrintingView(employees: employees)
