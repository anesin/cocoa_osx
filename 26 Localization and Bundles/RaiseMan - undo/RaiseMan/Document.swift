...
class Document: NSDocument {
    ...
    func insertObject(employee: Employee, inEmployeesAtIndex index: Int) {
        ...
        if !undo.undoing {
            let addPerson = NSLocalizedString("UNDO_ADD_PERSON", comment: "The undo action name - Add Person")
            print(addPerson)
    ...
    func removeObjectFromEmployeesAtIndex(index: Int) {
        ...
        if !undo.undoing {
            let removePerson = NSLocalizedString("UNDO_REMOVE_PERSON", comment: "The undo action name - Remove Person")
            print(removePerson)
